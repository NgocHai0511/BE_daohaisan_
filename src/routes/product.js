...
//POST -- api/product
router.post('/product', validateToken, upload.single('image'), productController.createProduct);
//PUT --api/product
router.put('/product/', validateToken, upload.single('image'), productController.updateProduct);
//POST --api/product
